...
def precook(s: str, n: int = 4, out: bool = False) -> Tuple[int, dict]:
    """
...
def cook_refs(
    refs: List[str], eff = None, n: int = 4
) -> Tuple[Union[int, float], dict]:  ## lhuang: oracle will call with "average"
    """
...
def cook_test(test: str, refs, eff: Optional[str] = None, n: int = 4) -> dict:
    """
...
class BleuScorer:
    ...
    def recompute_score(self, option: Optional[str] = None, verbose: int = 0):
        self._score = None
