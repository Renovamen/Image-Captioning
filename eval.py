...
# Parameters
data_folder = config.dataset_output_path  # folder with data files saved by data_preprocess.py
...
def evaluate(beam_size):
    ...
    # for each_image in ground_truth:
    #     for each_ref in each_image:
    #         generate_sentence(each_ref)
    #     print("\n")

    # for hypothesis in hypotheses:
    #     generate_sentence(hypothesis)
...
def generate_sentence(code_list):

    sentence = ""

    for code in code_list:
        sentence += rev_word_map[code] + " "
